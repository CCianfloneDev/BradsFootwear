...
<?php endif ?>
<div class="container" id="login_form" style="padding-top:40px;">
      ...
      <form method="post">
         <fieldset>
            <div class="form-group">
               ...
               <input class="form-control" name="user_name" id="user_name" style="max-width: 300px;" placeholder="Enter a username..." value="" required/>
            </div>
            <div class="form-group">
               <label for="user_pass">Password:</label>
               <input class="form-control" name="user_pass" id="user_pass" style="max-width: 300px;" type="password" placeholder="Enter a password..." value="" required/>
            </div>
